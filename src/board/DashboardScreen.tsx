        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          <div style={{ ...CARD, padding: '18px 20px' }}>
            ...
            >
              ...
              <div
                className="mono"
                style={{ fontSize: 13, fontWeight: 700, color: '#4a9b7f' }}
              >
                {dist.donePct}% готово
              </div>
            </div>
            ...
            >
              {dist.segs.map((s) => (
                <div key={s.key} style={{ width: s.pct, background: s.bg }} />
              ))}
            </div>
            <div
              style={{
                ...
                >
                  ...
                  <div
                    style={{
                      fontSize: 13.5,
                      fontWeight: 600,
                      color: m.done ? 'var(--text-faint)' : 'var(--text-3)',
                    }}
                  >
                    {m.label}
                  </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          style={{ fontSize: 10, color: 'var(--text-faint)', fontWeight: 600 }}
        >
          задач
        </span>
      </div>
